...
public class ProbeMessage3 implements Serializable{
	...
	public ProbeMessage3(int sender, int nnodes, LamportClock lc) {
	 ...
	 */
	public void setLc(LamportClock lc) {
		this.lc = new LamportClock(lc);
	}
	...
	public synchronized ProbeMessage3 copy() {
		ProbeMessage3 result = new ProbeMessage3(this.sender, this.nnodes, this.lc);
